...
{
    /// <summary>
    /// Manages a collection of spawn groups. Can override prefabs instantiated inside those. When spawning, selects the most appropriate group based on the player orientation and position.
    /// </summary>
