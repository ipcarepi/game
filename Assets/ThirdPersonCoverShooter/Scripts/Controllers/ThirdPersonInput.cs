...
namespace CoverShooter
{
    ...
    public class ThirdPersonInput : MonoBehaviour
    {
        ...
        public float GrenadeTime = 5f;
        public float currentGrenadeTime = 0;
        ...
        protected virtual void CheckGrenadeTime() {
            if (currentGrenadeTime > 0) {
        ...
        protected virtual void UpdateGrenade()
        {
            ...
            if (Input.GetButton("Grenade") && currentGrenadeTime <= 0){
        ...
        {
            if (Input.GetKey(KeyCode.Alpha1)) { _motor.InputCancelGrenade(); inputWeapon(2); }
