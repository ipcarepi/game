        ...
        public bool IsClose(SearchPoint point, float threshold, float middleThreshold)
        {
            ...
            foreach (var i in Indices)
                if (i < Data.Points.Count) {
                    ...
                    if (Vector3.Distance(Data.Points[Data.Points.Count - 1].Position, point.Position) < threshold &&
                        !AIUtil.IsObstructed(Data.Points[Data.Points.Count - 1].Position + Vector3.up,
                                            point.Position + Vector3.up,
                                            0.05f))
                        return true;                    
                }
